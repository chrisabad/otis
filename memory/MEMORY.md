...
- [Project: Honcho self-host](project-honcho-self-host.md) — Phases 1–4 COMPLETE (2026-06-10): Docker Compose on VPS, 5534 msgs migrated, all honcho.json pointing to http://100.117.92.5:8000; Phase 5 (cancel cloud sub + delete key) pending 24h soak validation
